...
export default function SettingsPage() {
  ...
  const [activeTab, setActiveTab] = useState<
    'account' | 'keys' | 'spend' | 'appearance' | 'danger'
  >('account')
  ...
  return (
    <main className="mx-auto min-h-dvh max-w-5xl px-6 py-10 animate-fade-in">
      ...
      <div className="mb-8 flex items-center gap-3 border-b border-white/5 pb-5">
        ...
        <div>
          <h1 className="text-xl font-bold font-cinzel text-zinc-100 tracking-wider">
            Ronald Forge settings
          </h1>
          <p className="text-[11px] text-zinc-500">
            Configure workspaces, models, caps, and appearance.
          </p>
        </div>
        <Link
          href="/workspaces"
          className="ml-auto text-xs text-zinc-400 border border-white/10 rounded-lg px-3 py-1.5 hover:text-zinc-200 hover:border-white/20 transition bg-black/20"
        >
          ← Back to workspaces
        </Link>
      </div>
              ...
              <button
                ...
                className={cn(
                  ...
                  activeTab === tab.id
                    ...
                    : 'bg-transparent text-zinc-400 border-transparent hover:bg-white/[0.03] hover:text-zinc-300',
                )}
              >
                {tab.label}
              </button>
          ...
          <div className="md:col-span-3 rounded-xl border border-white/10 bg-white/[0.01] p-6 glass-panel relative">
            ...
            {activeTab === 'account' && (
              <div className="space-y-6">
                <div>
                  <h2 className="text-sm font-semibold font-cinzel text-zinc-200 uppercase tracking-wider mb-1">
                    Account &amp; Plan
                  </h2>
                  <p className="text-[11px] text-zinc-500">
                    Review your profile details and billing plan status.
                  </p>
                </div>
                ...
                <div className="space-y-3.5 border-t border-white/5 pt-4">
                  ...
                  <div className="flex justify-between items-center text-xs">
                    ...
                    <span className="text-zinc-200 font-mono">
                      {isOwner
                        ? 'Unlimited token allocations & zero spend cap'
                        : 'Subject to user soft limit caps'}
                    </span>
                  </div>
                </div>
            ...
            {activeTab === 'keys' && (
              <div className="space-y-6">
                <div className="flex justify-between items-start">
                  <div>
                    <h2 className="text-sm font-semibold font-cinzel text-zinc-200 uppercase tracking-wider mb-1">
                      Developer Keys &amp; Model Overrides
                    </h2>
                    <p className="text-[11px] text-zinc-500">
                      Provide custom developer API credentials to run tasks with your own accounts.
                    </p>
                  </div>
                  {customKeysSaved && (
                ...
                <div className="space-y-4 border-t border-white/5 pt-4">
                  ...
                  <div className="space-y-1 pt-2 border-t border-white/5">
                    ...
                    <p className="text-[9px] text-zinc-500 leading-relaxed">
                      This model id is sent to the agent service whenever the custom model option is
                      selected in the compose bar.
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-[11px] text-zinc-500">
                      Configure how Forge controls model execution budget limits.
                    </p>
                  </div>
                  {savedMsg && (
                    <span className="text-[10px] font-bold text-emerald-400">{savedMsg}</span>
                  )}
                </div>
                ...
                {showSafety && (
                  <div className="rounded-lg border border-amber-500/40 bg-amber-500/10 p-4 space-y-3 animate-fade-in">
                    <p className="text-xs font-bold text-amber-400">
                      Enable unlimited top-up mode?
                    </p>
                    <p className="text-[10px] text-zinc-400 leading-relaxed">
                      In Unlimited Mode, Ronald Forge will pause execution and prompt you for
                      approval before allocating each small credit block. Every credit extension
                      requires an explicit tap to approve.
                    </p>
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="flex-1 rounded bg-zinc-800 px-3 py-1.5 text-xs font-semibold text-zinc-300 hover:bg-zinc-700 transition cursor-pointer"
                      >
                        Cancel
                      </button>
                    </div>
                ...
                <div className="rounded-lg border border-emerald-500/20 bg-emerald-500/5 px-3 py-2.5">
                  <p className="text-[10px] text-zinc-400 leading-relaxed">
                    <strong className="text-zinc-300">Safety guarantee:</strong> Forge will never
                    silently charge beyond your set limits. All credit allocations require your
                    active approval.
                  </p>
                </div>
            ...
            {activeTab === 'appearance' && (
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-[11px] text-zinc-500">
                    Customize appearance styles and client-side notifications preferences.
                  </p>
                </div>
                ...
                <div className="space-y-3 border-t border-white/5 pt-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    >
                      ...
                      <span className="text-[10px] text-zinc-500 mt-1 block font-cinzel">
                        Classic Toad gold and gear look
                      </span>
                    </button>
                  </div>
                </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-[10px] text-zinc-500 leading-relaxed mt-0.5">
                        Send system desktop alerts whenever background tasks complete or experience
                        errors.
                      </p>
                    </div>
                    <button
                      ...
                      className={cn(
                        ...
                        notificationsEnabled
                          ? 'border-[var(--brass)] bg-[var(--brass)]/80'
                          : 'border-zinc-700 bg-zinc-800',
                      )}
                    >
                      <span
                ...
                <div className="space-y-3 pt-4 border-t border-white/5">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-[10px] text-zinc-500 leading-relaxed mt-0.5">
                        When on, Ronald asks a few quick questions to understand what you want
                        before building. Turn it off to start building right away.
                      </p>
                    </div>
                    <button
                      type="button"
            ...
            {activeTab === 'danger' && (
              <div className="space-y-6">
                <div>
                  <h2 className="text-sm font-semibold font-cinzel text-red-400 uppercase tracking-wider mb-1">
                    Danger Zone
                  </h2>
                  <p className="text-[11px] text-zinc-500">
                ...
                <div className="rounded-xl border border-red-500/20 bg-red-500/5 p-4 space-y-4 border-t border-white/5 pt-4">
                  <div className="flex justify-between items-start gap-4">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-[10px] text-zinc-400 leading-relaxed">
                        This action will immediately destroy every sandboxed workspace, container
                        directory, deployment domain, and session history logs linked to your user
                        account.
                      </p>
                    </div>
                    <button
                      ...
                      className="rounded-lg bg-red-600 hover:bg-red-600 text-white font-bold px-3 py-2 text-xs transition cursor-pointer disabled:opacity-40 select-none shrink-0"
                    >
